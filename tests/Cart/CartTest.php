...
class CartTest extends TestCase
{
    ...
    public function itClearsCartAfterCheckout(): void
    {
        ...
        $this->assertEquals(['id' => 7, 'items' => [
            ['id' => 1, 'quantity' => 1, 'total_price' => 15000, 'tax' => 0, 'total_price_gross' => 15000],
            ['id' => 2, 'quantity' => 2, 'total_price' => 20000, 'tax' => 0, 'total_price_gross' => 20000],
        ], 'total_price' => 35000,
        'total_price_gross' => 35000], $order->getDataForView());
    }
    ...
    public function itProperlyCalculateTotalPriceGross(): void
    {
        ...
        $product2 = $this->buildTestProduct(2, 10000, 23);

        $cart = new Cart();
        $cart->addProduct($product1, 1)
            ->addProduct($product2, 2);

        $this->assertEquals(40350, $cart->getTotalPriceGross());
    }
